...
public class SendEmail {
    //发件人的邮箱和授权码
    private final String myEmailAccount = "2385432085@qq.com";
    private final String myEmailPassword = "ybinefgfrsfddhjg";
    ...
    public MimeMessage createMessage(Session session, String sendMail, String receiveMail, String info) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "花椒社区网站", "UTF-8"));
    ...
    public static void sendCodeToEmail(String email) {
        ...
        sb.append("verification code: "+str+" .You are modifying your password. Thank you for your support!\n");
    ...
    public static void main(String[] args) {
        sendCodeToEmail("sun21907991@dingtalk.com");
    }
